!(function (a, b) {
  ...
  function h(a, b, c) {
    var d, e, f
    switch (a == 'openEnterpriseChat' && (b.errCode = b.err_code), delete b.err_code, delete b.err_desc, delete b.err_detail, d = b.errMsg, d || (d = b.err_msg, delete b.err_msg, d = i(a, d), b.errMsg = d), c = c || {}, c._complete && (c._complete(b), delete c._complete), d = b.errMsg || '', D.debug && !c.isInnerInvoke && alert(JSON.stringify(b)), e = d.indexOf(':'), f = d.substring(e + 1)) {
      case 'ok':
  ...
  function i(a, b) {
    var e, f, c = a, d = q[c]
    return d && (c = d), e = 'ok', b && (f = b.indexOf(':'), e = b.substring(f + 1), e == 'confirm' && (e = 'ok'), e == 'failed' && (e = 'fail'), e.indexOf('failed_') != -1 && (e = e.substring(7)), e.indexOf('fail_') != -1 && (e = e.substring(5)), e = e.replace(/_/g, ' '), e = e.toLowerCase(), (e == 'access denied' || e == 'no permission to execute') && (e = 'permission denied'), c == 'config' && e == 'function not exist' && (e = 'ok'), e == '' && (e = 'fail')), b = c + ':' + e
  }
  ...
  if (!a.jWeixin) {
    return p = {
      ...
      for (b in p)a[p[b]] = b
      return a
    }()), r = a.document, s = r.title, t = navigator.userAgent.toLowerCase(), u = navigator.platform.toLowerCase(), v = !(!u.match('mac') && !u.match('win')), w = t.indexOf('wxdebugger') != -1, x = t.indexOf('micromessenger') != -1, y = t.indexOf('android') != -1, z = t.indexOf('iphone') != -1 || t.indexOf('ipad') != -1, A = (function () {
      ...
      getNetworkType: function (a) {
        var b = function (a) {
          ...
          if (a.errMsg = 'getNetworkType:ok', c = a.subtype, delete a.subtype, c)a.networkType = c; else {
